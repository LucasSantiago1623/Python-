...
class Operacao(db.Model):
    ...
    num2 = db.Column(db.Float, nullable=True)   # nullable=True para suportar sqrt
    ...
    criado_em = db.Column(db.DateTime, nullable=False, default=datetime.utcnow)  # campo adicionado
